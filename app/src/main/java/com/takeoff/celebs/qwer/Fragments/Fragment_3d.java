...
public class Fragment_3d extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment1_3d, container, false);

        recyclerView = view.findViewById(R.id.a3d_recycle);
        ...
        for(int i=0;i<photoSource.a3d_source.length;i++){
           PhotoBean item = new PhotoBean();
           int num = Get_like_num();
           item.setUrl(photoSource.a3d_source[i]);
           item.setName(num +"K");
           datalist.add(item);
        }
