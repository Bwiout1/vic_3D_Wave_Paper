...
public class Fragment_parallax_3d extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment2_parallax, container, false);

        recyclerView = view.findViewById(R.id.parallax_recycle);
        ...
        for(int i=0;i<photoSource.parallax.length;i++){
            PhotoBean item = new PhotoBean();
            int num = Get_like_num();
            item.setUrl(photoSource.parallax[i]);
            item.setName(num +"K");
            datalist.add(item);
        }
        ...
        photoAdapter.setOnItemClickListener(new PhotoAdapter.onItemViewClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.putExtra("kinds","parallax");
